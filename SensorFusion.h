...
// 23/11/2017  Aste   r      Optimised time handling and melted in one library
// 04/03/2020  OHagendorf    Adaption to Mbed OS
//
//=============================================================================================
...
public:
  ...
  float deltatUpdate (int time_ms) {
    deltat = ((time_ms - lastUpdate) / 1000000.0f); // set integration time by time elapsed since last filter update
    lastUpdate = time_ms;
    return deltat;
  }
